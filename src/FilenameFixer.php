...
namespace gluehq\filenamefixer;

use gluehq\filenamefixer\models\Settings;
 ...
 * @since     1.0.0
 *
 * @property  FilenameService $filename
 * @property  Settings $settings
 * @method    Settings getSettings()
 */
class FilenameFixer extends Plugin
{
    // Static Properties
    // =========================================================================
        ...
        Event::on(
            ...
            function(Event $event) {
                ...
                if ($element instanceof craft\elements\Asset) {
                    FilenameFixer::$plugin->filename->rename($element, 'EVENT_AFTER_SAVE_ELEMENT');
                }
            }
        );
